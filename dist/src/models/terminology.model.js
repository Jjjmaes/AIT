...
const mongoose_paginate_v2_1 = __importDefault(require("mongoose-paginate-v2")); // Import pagination plugin
...
TerminologySchema.plugin(mongoose_paginate_v2_1.default);
