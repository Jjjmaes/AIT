...
class ProjectService {
    ...
    async createProject(data) {
        ...
        try {
            ...
            const project = new project_model_1.Project({
                ...data,
                manager: new mongoose_1.Types.ObjectId(data.manager), // Ensure manager is ObjectId
            ...
            await project.save();
            logger_1.default.info(`Project created: ${project.id} by manager ${data.manager}`);
            return project;
        }
        catch (error) {
    ...
    async getProjectById(projectId, userId) {
        ...
        (0, errorHandler_1.validateOwnership)(project.manager, userId, '查看项目');
        return project;
    }
    /**
     * 更新项目信息
