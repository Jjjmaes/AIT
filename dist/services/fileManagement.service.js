...
class FileManagementService {
     ...
     */
    async processUploadedFile(projectId, userId, fileInfo, sourceLang, targetLang) {
        ...
        try {
            ...
            const processingResult = await fileProcessor_factory_1.FileProcessorFactory.processFile(fileRecord.path, fileRecord.type);
    ...
    async getFileById(fileId, projectId, userId) {
    ...
    async getFilesByProjectId(projectId, userId) {
    ...
    async deleteFile(fileId, projectId, userId) {
