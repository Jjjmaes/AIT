...
describe('TranslationCacheService', () => {
  ...
  beforeEach(() => {
    cacheService = new TranslationCacheService(testConfig);
  });
  ...
  describe('Get and Set', () => {
    ...
    test('should handle expired values', () => {
      ...
      const expiredConfig: CacheConfig = {
        ...testConfig,
        ttl: 0
      };
      const expiredCache = new TranslationCacheService(expiredConfig);
  ...
  describe('Cleanup', () => {
    ...
    test('should respect max size limit', () => {
      ...
      const limitedCache = new TranslationCacheService(limitedConfig);
